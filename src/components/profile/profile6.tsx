...
type DemoProps = { onToggle: (expanded: boolean) => void };

const Demo = ({ onToggle }: DemoProps) => {
    return (
        <Box position="relative" pb="50px">
            <Accordion.Root collapsible variant={"plain"} onValueChange={(details) => {
                onToggle(details.value.includes("item-1"));
            }}>
                        ...
                        <Accordion.ItemBody>
                            <Box>
                                ...
                                <HStack justify="center" mb={3}>
                                    {[1, 2, 3].map((i) => (
                                        <HStack key={i} px={3} py={1} borderRadius="full" bg="gray.100">
...
const ProductCard = ({ image, name, username, followers, rating, price, category }: ProductCardProps) => {
    return (
        <Box
  ...
  fontFamily="Helvetica Neue"
        ...
        opacity={0.3}
            ...
            color="white"
              ...
              <VStack align="flex-start">
                <Text fontWeight="700" fontSize="18px">{name}</Text>
                <Text fontSize="14px" opacity={0.8}>{username}· {followers}</Text>
              </VStack>
       ...
       <Box position="absolute" bgColor={"#F9F5FF"} w="268px" h="281px" borderRadius={"24px"} textAlign={"center"} 
                    spaceY={"10px"}
                    mt="-250px" zIndex={0}>
             <Text fontWeight="700" color="#7344E4" mt="250px" >Sponsor dès <span style={{color:"#7344E4"}}>{price}</span></Text>
       </Box>
      
          <Text fontSize="14px" color="#7B7B7C" mt="10px">{category}</Text>
        </VStack>
        </Box>
    );
};
...
export default function Profile6() {
    ...
    // Product data array - easily customizable
    const products = [
        {
            image: "/215.png",
            name: "Nettoyant doux",
    ...
    return (
        <>
            <Box bgGradient="to-b" gradientFrom="#F2EDFC " gradientTo="#FFF5F9"color={"black"} mt="40px" minH={"100vh"}>
                ...
                >
                    ...
                    >
                        <Flex justify="space-between" align="center" mb={3} mt="-30px">
                            <Image src="/curology.png" alt="Curology" w="99px" h="99px" />
                            <HStack>
                ...
                <Box>
                    <Box
                        maxW={isExpanded ? "calc(100% - 400px)" : "calc(100% - 200px)"}
                        ml={isExpanded ? "400px" : "100px"}
                        mr="100px"
     ...
     w="1200px"
                        ...
                        >
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    borderRadius="20px"
                                >
                                    <Icon as={FaSearch} color="white" w="20px" h="19px" />
                                </Button>
                            </Flex>
                        ...
                        <Box
                            ...
                            gridTemplateColumns={{
                                ...
                                sm: "repeat(2, 1fr)",
                                md: "repeat(3, 1fr)",
                                lg: isExpanded ? "repeat(3, 1fr)" : "repeat(4, 1fr)"
                            }}
                            gap={4}
                            maxW="1200px" mx="auto" w="1200"
                        >
                ...
                {/* <Flex w="100%" justify="space-between" align="center" py="20px">
                    ...
                    <HStack fontFamily="Helvetica Neue" fontSize="14px" color="#1A1A1A" mr="90px">
                        <Text>Page</Text>
                        <Box
                            w="48px"
                            h="32px"
