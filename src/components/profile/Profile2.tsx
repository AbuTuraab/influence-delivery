...
export default function Profile2Page() {
  ...
  const campaigns = [
    ...
    { icon: <Image src="src/assets/unbox.svg" />, title: "Vidéo unboxing", price: "325€" },
  ];
          ...
          <Box   w={{ base: "100%", lg: "392px" }}h="100%" bg="white" borderRadius="24px" p={5} boxShadow="0px 8px 16px #0000000F">
                ...
                <Grid templateColumns="repeat(3, 1fr)" gap={4} width="100%">
                  ...
                  >
                    <VStack  textAlign="center">
                      <Image
                        src="src/assets/logo-tiktok-noir.svg"
                        boxSize="24px"
                        alt="TikTok"
                      />
                  ...
                  >
                    <VStack  textAlign="center">
                      <Image
                        src="src/assets/logo-instagram-noir.svg"
                        boxSize="24px"
                        alt="Instagram"
                      />
                      <Text fontSize="sm" fontWeight="medium" color="#636363">
            ...
            <Box>
              <VStack color="black" textAlign={"center"} pt={3}>
                <Image src="src/assets/union.svg" h="17px" w="17px" />
                <Text fontFamily="Helvetica Neue"
                  fontWeight="bold"
                  fontSize="16px"
                  lineHeight="19px"
